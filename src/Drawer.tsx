/**
 * @file Drawer.tsx
 * @description This file contains the Drawer component, which is used to display a responsive drawer. The Drawer can be positioned on any side of the screen (right, left, top, or bottom) and includes animations for opening and closing. It also provides an overlay to darken the background when the drawer is open, enhancing the user experience by focusing attention on the drawer content.
 */
